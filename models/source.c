...
/**
 * Source file includes (include header pair first)
 */
...
/*****************************************************************************
 *
 * Explanation about what the function do (never call parameters by their
 * names to avoid oversights)
 *
 * NOTE: Important catch-eye note
 ...
 *
 * Return value
 *     Explanation about the return value (never call parameters by their
 *     names to avoid oversights)
 *     (If no return value, use "None")
 *
 *****************************************************************************/
/**
